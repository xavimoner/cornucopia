...
async def run(playwright):
    ...
    # Aquí ja disposes de les variables:
    #   web_content_text -> contingut complet de la pàgina web "Proyectos de I + D"
    #   pdf_content_text -> contingut complet del PDF
    #
    ...
    # Opcional: imprimir per consola les primeres línies
